...
//        var socket = connection.Transport;
...
//                    await connection.Transport.CloseAsync(WebSocketCloseStatus.NormalClosure, "Closing", CancellationToken.None);
//                    break;
//                }
...
//                    await connection.Transport.CloseAsync(WebSocketCloseStatus.MessageTooBig, "Message exceeds size limit", CancellationToken.None);
//                    break;
//                }
