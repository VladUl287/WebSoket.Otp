  ...
  <div class="chat-container">
    ...
    <div class="chat-controls">
      <div class="connection-controls">
        <input v-model="username" placeholder="Your username" class="username-input" :disabled="isConnected"
          @keyup.enter="toggleConnection" />
        <button @click="toggleConnection" :class="['connection-btn', isConnected ? 'disconnect' : 'connect']"
...
const { status, isConnected, messages, username, newMessage, connect, disconnect, sendMessage } = useChatWebSocket()
